...
| `0x4127` / `0x4124` | `field_4127_raw` / `field_4124_raw` | `40` | 234–1048 (5 distinct) / 0–1000 (4 distinct) | Candidates labelled battery temperatures by the source. Both are near-constant, which is itself suspicious |
