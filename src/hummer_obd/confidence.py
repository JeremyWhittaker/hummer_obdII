...
CONFIDENCE: Final[dict[str, Evidence]] = {
    ...
    "4127": Evidence(3, ("40",), ("parked", "driving", "charging"),
                     ...
                     "WHAT HOLDS, now on independent data: value 1048 means "
                     "the powertrain is not reporting road speed. In the "
                     "second drive all 22 samples with no speed reported read "
                     "1048, and no sample with a speed did -- matching 477 of "
                     "477 corpus samples on the same rule. "
