...
CONFIDENCE: Final[dict[str, Evidence]] = {
    ...
    "4149": Evidence(1, ("40",), ("parked", "driving", "charging"),
                     ...
                     "0x4149 read 96 for the first 29 minutes and then 160 for "
                     "14 samples from 02:59:37, after which module 40 stopped "
                     "answering it -- the same settled-charge quiet already "
                     "recorded. If 160 is confirmed as this charge's value it "
                     "is decisive, because the field would then read 160 for "
                     "both a 40.2 A and a 12 A supply, and an advertised "
                     "current cannot be equal for sources differing 3.35x. "
