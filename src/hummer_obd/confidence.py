...
CONFIDENCE: Final[dict[str, Evidence]] = {
    ...
    "4149": Evidence(1, ("40",), ("parked", "driving", "charging"),
                     ...
                     "SECOND EVSE, 2026-09-05, re-derived against the CLOSED "
                     "351-row session and unchanged from the provisional read. "
                     "A 12 A / 120 V cordset (Yura 91686-G5020, nameplate read "
                     "by the owner) was connected at 02:30:49. The charger "
                     "state took 0x0C and later 0x0D -- 210 and 125 samples -- "
                     "and 0x0C was absent from all 7117 prior rows, so this "
                     "charge type is distinguishable from the 240 V ones, "
                     "which use the 0x93-0x99 family exclusively. The charge "
                     "settled at 0.535 kW into the pack by two agreeing "
                     "routes. "
